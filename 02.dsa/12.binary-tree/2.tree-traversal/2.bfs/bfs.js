...
=> Breadth first search(BFS) :-
    ...
    ->  It starts at the root of the tree or graph and explores all nodes at the current depth level 
        before moving on to nodes at next depth level.
...
=> Steps to breadth first search:
	->  Create a queue (this can be an array or linked list) and an array/linked-list variable to store 
