/*
=> Heap:
    -   A heap is a tree-based data structure that's used in algorithms like Dijkstra's 
...
/*
=> BinaryHeaps:
    -   Binary heap is similar to binary search tree, but there are some different rules 
        that is order of sibling nodes are not considered as binary search tree.
...
=>  Complete Binary tree:
    - Every node apart fro root and leaf, must have 2 nodes
*/
/*
...
=> Why do we need heaps?
    -   Binary Heaps are used to implements priority queues, which are very common used 
        data structure.
