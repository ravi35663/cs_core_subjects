...
=> Advantages:
    ...
    2)  Avoids unnecessary implementation of irrelevant methods, ensuring cleaner and more maintainable 
        code.

Note: By splitting the interface, both Dog and Bird can have behaviors appropriate to their nature without 
      being forced to implement unnecessary methods.
*/