...
-   Here: The VehicleService should only be dealing with driving the vehicle and should not be dealing 
    with object creation logic:

-   Here every time we passing the type it is creating the object and implementing the driving logic 
    which is two thing.
